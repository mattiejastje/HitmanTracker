...
local EngineData = d.Struct("EngineData", {
    ...
    d.Seek(0x37B5),
    d.Field(d.Double, "game_time"),  -- total scaled time
    d.Field(d.Double, "game_raw_time"),  -- total raw time
    d.Field(d.Double, "game_time_copy"),
    d.Field(d.Double, "game_time_previous"),
    d.Seek(0x37E5),
    ...
    d.Field(d.Double, "game_raw_time_delta"),  -- smoothed delta time
    d.Seek(0x3BDB),
