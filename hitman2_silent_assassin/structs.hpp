...
using TLevelControl = Struct<
    LevelControl,
    Fields<
        Seek<0x154>,
        Field<TSmallString, &LevelControl::unk_scene_name>,
        Seek<0x208>,
        Field<Int32, &LevelControl::headshots>,
        Field<Int32, &LevelControl::enemies_wounded>,
        Field<Int32, &LevelControl::enemies_killed>,
        Field<Int32, &LevelControl::innocents_wounded>,
        Field<Int32, &LevelControl::innocents_killed>,
        Field<Int32, &LevelControl::alerts>,
        Field<Int32, &LevelControl::close_encounters>>>;
...
using TPlayerData = Struct<
    PlayerData,
    Fields<Seek<0x11c7>, Field<Int32, &PlayerData::shots_fired>>>;
...
using TGRefManager = Struct<
    ...
    Fields<
        ...
        Seek<0x24>,
        Field<Int32, &GRefManager::unk_24_flag>,
...
using TSceneManager = Struct<
    ...
    Fields<
        Skip<0x4>,
        Field<Ref<TGRefManager>, &SceneManager::gref_manager>,
        Seek<0xc4>,
        Field<Ref<TSceneEntities>, &SceneManager::entities>,
        Seek<0xbb7>,
